      ...
      <div className="max-w-6xl mx-auto text-center">
        ...
        >
          {techSkills.map((skill, index) => (
            <motion.div
              key={index}
              className="flex flex-col items-center justify-center gap-2 p-1 shadow-md rounded-xl bg-stone-100 dark:bg-stone-700 hover:scale-105 transition-transform duration-300"
