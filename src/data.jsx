...
export const techSkills = [
  ...
  { name: 'Supabase', icon: <SiSupabase className="text-green-600" />, level: 'intermediate' },
  { name: 'PHP', icon: <FaPhp className="text-indigo-600" />, level: 'intermediate' },
  { name: 'MySQL', icon: <SiMysql className="text-blue-500" />, level: 'intermediate' },
  { name: 'NODE JS', icon: <FaNodeJs className="text-indigo-600" />, level: 'basics' },
  { name: 'PYTHON', icon: <FaPython className="text-blue-500" />, level: 'basics' },
];
